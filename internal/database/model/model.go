...
type Node struct {
	...
	OutboundBridgeEnable bool     `json:"outboundBridgeEnable" form:"outboundBridgeEnable" gorm:"column:outbound_bridge_enable;default:false"`
	OutboundBridgeTags   []string `json:"outboundBridgeTags" form:"outboundBridgeTags" gorm:"serializer:json;column:outbound_bridge_tags"`
